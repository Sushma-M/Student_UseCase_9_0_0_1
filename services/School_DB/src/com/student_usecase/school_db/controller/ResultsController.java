...
public class ResultsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Results getResults(@RequestParam(value = "testConductedId", required = true) Integer testConductedId, @RequestParam(value = "studentId", required = true) Integer studentId, @RequestParam(value = "academicYear", required = true) String academicYear, @RequestParam(value = "standardId", required = true) Integer standardId) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Results editResults(@RequestParam(value = "testConductedId", required = true) Integer testConductedId, @RequestParam(value = "studentId", required = true) Integer studentId, @RequestParam(value = "academicYear", required = true) String academicYear, @RequestParam(value = "standardId", required = true) Integer standardId, @RequestBody Results results) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteResults(@RequestParam(value = "testConductedId", required = true) Integer testConductedId, @RequestParam(value = "studentId", required = true) Integer studentId, @RequestParam(value = "academicYear", required = true) String academicYear, @RequestParam(value = "standardId", required = true) Integer standardId) throws EntityNotFoundException {
        ResultsId resultsId = new ResultsId();
        resultsId.setTestConductedId(testConductedId);
        resultsId.setStudentId(studentId);
        resultsId.setAcademicYear(academicYear);
