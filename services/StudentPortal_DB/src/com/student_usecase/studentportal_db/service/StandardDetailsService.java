...
public interface StandardDetailsService {
	 ...
	 */
	StandardDetails getById(String standarddetailsId) throws EntityNotFoundException;
	 ...
	 * @return StandardDetails associated with the given standarddetailsId.
	 */
	StandardDetails findById(String standarddetailsId);
	 ...
	 */
	StandardDetails delete(String standarddetailsId) throws EntityNotFoundException;
     ...
     * @see Page
     */
    Page<Academics> findAssociatedAcademicses(String standardId, Pageable pageable);
