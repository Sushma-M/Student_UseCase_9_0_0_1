...
public class AcademicSubjectsServiceImpl implements AcademicSubjectsService {
    ...
    @Transactional(readOnly = true, value = "StudentPortal_DBTransactionManager")
    @Override
    public Page<AcademicTestSubjects> findAssociatedAcademicTestSubjectses(Date academicYear, String standard, Integer subjectId, Pageable pageable) {
        ...
        queryBuilder.append("academicSubjects.standard = '" + standard + "'");
        queryBuilder.append(" and ");
