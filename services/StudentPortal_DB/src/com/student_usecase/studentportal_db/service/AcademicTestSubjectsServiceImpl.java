...
public class AcademicTestSubjectsServiceImpl implements AcademicTestSubjectsService {
    ...
    @Transactional(readOnly = true, value = "StudentPortal_DBTransactionManager")
    @Override
    public Page<Results> findAssociatedResultses(Date academicYear, String standard, Integer testId, Integer subjectId, Pageable pageable) {
        ...
        queryBuilder.append("academicTestSubjects.standard = '" + standard + "'");
        queryBuilder.append(" and ");
